...
public class SchoolWeb extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new SchoolWeb.MyWebViewClient());
        webView.getSettings().setJavaScriptEnabled(true);
        String value = getIntent().getStringExtra("uid");
        final String webViewUrl = "https://www.uoeld.ac.ke";
    ...
    public void homeclick(View view) {
        Intent intent= new Intent(SchoolWeb.this, SchoolWeb.class);
    ...
    public class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
            ...
            if (webViewProgressBar.isShown())
                webViewProgressBar.setVisibility(View.GONE);
            Toast.makeText(SchoolWeb.this, "Fetching data.", Toast.LENGTH_SHORT).show();
